...
class map_navigation():
  ...
  def choose(self):
    ...
    rospy.loginfo("|'1': Goal_1: (1.0 , 1.5)")
    rospy.loginfo("|'2': Goal_2: (2.5 , 1.5) ")
    rospy.loginfo("|'3': Goal_3: (5.0 , 1.5) ")
    rospy.loginfo("|'4': Goal_4: (7.0 , 1.5) ")
...
##############-- move to the destination --##################
  def moveToGoal(self,xGoal,yGoal):
      ...
      if(ac.get_state() ==  GoalStatus.SUCCEEDED):
        ...
        duration = end - start
        rospy.loginfo("Duration: %s s"%duration)
        ...
        #print(i)
        #print('************')
        rospy.loginfo("Path_length: %s cm"%path_length)
        self.xy = []
        #####################################
